...
class Hashviz {
  ...
  /// string. Returns a List of integers representing the image data.
  List<int> generatePatternData() {
    _randSeed = _createRandSeed(hash);
  ...
  List<int> _createRandSeed(String seed) {
